		...
		<div className={"max-w-screen-2xl container mx-auto xl:px-24 px-4"}>
			<div className={"my-jobs-container"}>
				...
				<div className={"p-2 text-center mb-2"}>
					<input onClick={handleSearch} onChange={(event) => setSearchText(event.target.value)} type={"text"}
							...
							<div className="w-full md:w-6/12 px-4 mx-auto text-center">
								<div className="text-sm text-blueGray-500 font-semibold py-1">
									Made with <a href="https://www.creative-tim.com/product/notus-js"
															 className="text-blueGray-500 hover:text-gray-800" target="_blank">Notus JS</a> by <a
									href="https://www.creative-tim.com" className="text-blueGray-500 hover:text-blueGray-800"
